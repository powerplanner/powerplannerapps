...
namespace Vx.InputValidation
{
    ...
    {
        public TextField(string initialText = "", bool required = false, IInputValidator inputValidator = null, int? minLength = null, int? maxLength = null, TextField mustMatch = null, VxPage viewModel = null, bool ignoreOuterSpaces = false, bool reportValidatorInvalidInstantly = false)
        {
            _text = initialText;
            Required = required;
            MinLength = minLength;
        ...
        public VxPage ViewModel { get; private set; }
