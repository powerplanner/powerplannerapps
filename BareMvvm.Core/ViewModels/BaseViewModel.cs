    ...
    public abstract class BaseViewModel : VxComponent
    {
        ...
        protected void OnPropertyChanged(params string[] propertyNames)
        {
            for (int i = 0; i < propertyNames.Length; i++)
                base.OnPropertyChanged(propertyNames[i]);
        }
        ...
        public void PrepareComponentForDisplay()
        {
        ...
        protected bool ValidateAllInputs(bool showValidationErrorMessage = true, Dictionary<string, Action<TextField>> customValidators = null)
        {
            ...
            {
                new PortableMessageDialog(BareMvvm.Core.Strings.Resources.InvalidInputs_Content, BareMvvm.Core.Strings.Resources.InvalidInputs_Title).Show();
            }
