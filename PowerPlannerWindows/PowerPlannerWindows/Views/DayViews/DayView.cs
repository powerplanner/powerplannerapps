...
namespace PowerPlannerUWP.Views.DayViews
{
    public class DayView : SlideView
    {
        private class DayGenerator : SlideViewContentGenerator
        {
            ...
            public Microsoft.UI.Xaml.FrameworkElement GetCurrent()
            {
        ...
        protected override void OnChangedCurrent(Microsoft.UI.Xaml.FrameworkElement oldEl, Microsoft.UI.Xaml.FrameworkElement newEl)
        {
            try
            {
