...
namespace PowerPlannerUWP.Views
{
    public sealed partial class CompletionSlider : UserControl
    {
        ...
        /// LightGreen
        /// </summary>
        private static readonly Brush COMPLETE_BRUSH = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 42, 222, 42)); // #2ade2a
        private static readonly Brush UNSELECTED_BRUSH = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 110, 110, 110));
