...
namespace PowerPlannerUWP.Views.ScheduleViews
{
    public class DayScheduleSnapshot : Button
    {
        ...
        private class MyScheduleItem : Grid
        {
            public MyScheduleItem(ViewItemSchedule s)
            {
                ...
                base.VerticalAlignment = Microsoft.UI.Xaml.VerticalAlignment.Top;
                ...
                TextBlock tbClass = new TextBlock()
                {
                    ...
                    Margin = new Microsoft.UI.Xaml.Thickness(6, 0, 6, 0),
                ...
                if (showTimeText)
                {
                    ...
                    tbTime = new TextBlock()
                    {
                        ...
                        Foreground = Brushes.White,
                        FontWeight = FontWeights.SemiBold,
                        Margin = new Microsoft.UI.Xaml.Thickness(6, -2, 6, 0),
                        TextWrapping = Microsoft.UI.Xaml.TextWrapping.NoWrap,
                        FontSize = 14
                    };
                }
                ...
                else
                {
                    if (showTimeText)
                    {
                        ...
                        tbTime.VerticalAlignment = Microsoft.UI.Xaml.VerticalAlignment.Bottom;
                        Grid.SetRow(tbTime, 2);
                        base.Children.Add(tbTime);
                    }

                    tbRoom.Margin = new Thickness(tbRoom.Margin.Left, tbRoom.Margin.Top, tbRoom.Margin.Right, 8);
                    tbRoom.VerticalAlignment = Microsoft.UI.Xaml.VerticalAlignment.Bottom;
        ...
        public DayScheduleSnapshot()
        {
            ...
            base.HorizontalAlignment = Microsoft.UI.Xaml.HorizontalAlignment.Stretch;
        ...
        private void render()
        {
            ...
            {
                Fill = new SolidColorBrush((Windows.UI.Color)Application.Current.Resources["SystemAltHighColor"])
            };
    ...
    public abstract class MyBaseEventVisual : Grid
    {
        ...
        private void MyBaseEventVisual_TappedForOpen(object sender, Microsoft.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
        ...
        private void MyBaseEventVisual_Tapped(object sender, Microsoft.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            if (ShowFull())
            {
                e.Handled = true;
        ...
        private void MyFullEventItem_PointerEntered(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            e.Handled = true;
            ShowFull();
        }
    ...
    public class MyFullEventItem : MyBaseEventVisual
    {
        ...
        protected override FrameworkElement GenerateContent(DayScheduleItemsArranger.EventItem item)
        {
            ...
            {
                Foreground = Brushes.White,
                Margin = new Microsoft.UI.Xaml.Thickness(6, 6, 0, 0),
                Text = item.Item.Name
            };
        ...
        private void ShowContextFlyout(UIElement sender, Microsoft.UI.Xaml.Input.ContextRequestedEventArgs args)
        {
