...
namespace PowerPlannerUWP.Views
{
    public sealed partial class MainScreenView : ViewHostGeneric
    {
        ...
        private void setProgressBarVisibility(bool visible)
        {
            ...
            if (!visible)
                _storyboardProgressBar.Completed += delegate { progressBar.Visibility = Microsoft.UI.Xaml.Visibility.Collapsed; };
        ...
        private void setProgressBarUploadImagesVisibility(bool visible)
        {
            ...
            if (visible)
                progressBarUploadImages.Visibility = Microsoft.UI.Xaml.Visibility.Visible;
            ...
            if (!visible)
                _storyboardProgressBarUploadImages.Completed += delegate { progressBarUploadImages.Visibility = Microsoft.UI.Xaml.Visibility.Collapsed; };
        ...
        {
            return sideBarMenuItems.Visibility == Microsoft.UI.Xaml.Visibility.Visible;
        }

        private void ShowMenu()
        {
            ContentPresenter.Visibility = Microsoft.UI.Xaml.Visibility.Collapsed;
            sideBarMenuItems.Visibility = Microsoft.UI.Xaml.Visibility.Visible;
        ...
        private void HideMenu()
        {
            ...
            {
                sideBarMenuItems.Visibility = Microsoft.UI.Xaml.Visibility.Collapsed;
                ContentPresenter.Visibility = Microsoft.UI.Xaml.Visibility.Visible;
