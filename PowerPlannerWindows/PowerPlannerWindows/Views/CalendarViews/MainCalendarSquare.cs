...
namespace PowerPlannerUWP.Views.CalendarViews
{
    public class MainCalendarSquare : TCalendarSquare
    {
        ...
        {
            base.Margin = new Microsoft.UI.Xaml.Thickness(1.5);

            base.RowDefinitions.Add(new Microsoft.UI.Xaml.Controls.RowDefinition() { Height = new GridLength(HEADER_HEIGHT) });
            base.RowDefinitions.Add(new Microsoft.UI.Xaml.Controls.RowDefinition() { Height = new GridLength(1, GridUnitType.Star) });
