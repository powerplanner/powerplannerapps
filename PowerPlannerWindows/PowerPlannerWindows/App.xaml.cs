...
namespace PowerPlannerUWP
{
    ...
    /// </summary>
    public partial class App : NativeUwpApplication
    {
        /// <summary>
        ...
        protected override async System.Threading.Tasks.Task OnLaunchedOrActivated(Microsoft.UI.Xaml.LaunchActivatedEventArgs e)
        {
            try
            {
#if DEBUG
                ...
                if (true)
                {
                    ...
                    await HandleArguments(mainAppWindow, "", LaunchSurface.Normal);
                }
