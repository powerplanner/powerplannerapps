...
{
    internal class ThemeColorSettingsViewModel : PopupComponentViewModel
    {
        ...
        public ThemeColorSettingsViewModel(BaseViewModel parent) : base(parent)
        {
            Title = PowerPlannerResources.GetString("Settings_ThemeColor_Title").ToUpper();
        ...
        private bool IsDirty => _selectedColor.Value != OriginalColor;
        ...
        private async void SaveChanges()
        {
            ...
            try
            {
                ...
                // Default color is stored as null
    ...
    internal static class ThemeColorViewExtensions
    {
        /// <summary>
        /// Wraps a view in a ListItemButton to make it clickable.
        /// </summary>
