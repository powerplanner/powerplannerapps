...
{
    public class AddTaskOrEventView : PopupViewHost<AddTaskOrEventViewModel>
    {
        private Spinner _spinnerClass;
        private Spinner _spinnerWeight;
        private Spinner _spinnerTimeOption;

        public AddTaskOrEventView(ViewGroup root) : base(Resource.Layout.AddTaskOrEvent, root)
        {
        }
        ...
        public override void OnViewModelLoadedOverride()
        {
            ...
            FindViewById<EditingImageAttachmentsWrapGrid>(Resource.Id.EditingImageAttachmentsWrapGrid).RequestedAddImage += AddTaskOrEventView_RequestedAddImage;
        ...
        private void CreateRecurrenceControlIfNotExists()
        {
            ...
            var repeatsSubControl = new AddTaskOrEventRepeatsSubControl(container)
            {
