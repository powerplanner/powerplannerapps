...
{
    public class ClassHomeworkOrExamsView : InterfacesDroid.Views.PopupViewHost<ClassHomeworkOrExamsViewModel>
    {
        public ClassHomeworkOrExamsView(ViewGroup root, ClassHomeworkOrExamsViewModel viewModel) : base(Resource.Layout.ClassHomeworkOrExams, root)
        {
            ViewModel = viewModel;
        }
        ...
        private DateGroupedHomeworkAdapter _oldItemsAdapter;
