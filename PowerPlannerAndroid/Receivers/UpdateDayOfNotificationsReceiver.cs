...
{
    [BroadcastReceiver]
    public class UpdateDayOfNotificationsReceiver : BroadcastReceiver
    {
        public override async void OnReceive(Context context, Intent intent)
        {
            ...
            try
            {
                ...
                await AndroidRemindersExtension.UpdateAndScheduleDayOfNotifications(context, localAccountId, fromForeground: false);
            }
            catch (Exception ex)
            {
