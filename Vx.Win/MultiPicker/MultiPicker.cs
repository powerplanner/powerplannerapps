...
namespace InterfacesUWP
{
    public class MultiPicker : Grid
    {
        ...
        public MultiPicker()
        {
            ...
            _listBox = new ListBox() { SelectionMode = Microsoft.UI.Xaml.Controls.SelectionMode.Multiple };
        ...
        void MultiPicker_Tapped(object sender, Microsoft.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            _messageBox.Show();
        }
