...
namespace InterfacesUWP
{
    public class CalendarPicker : SlideView
    {
        ...
        private class CalendarGrid : Grid
        {
            ...
            {
                protected virtual Brush ThisMonth { get { return new SolidColorBrush(Windows.UI.Color.FromArgb(255, 230, 230, 230)); } }
                ...
                protected virtual Brush OtherMonth { get { return new SolidColorBrush(Windows.UI.Color.FromArgb(255, 190, 190, 190)); } }
                protected virtual Brush OtherMonthMouse { get { return new SolidColorBrush(Windows.UI.Color.FromArgb(255, 220, 220, 220)); } }
                ...
                protected virtual Brush OtherMonthSelected { get { return new SolidColorBrush(Windows.UI.Color.FromArgb(255, 190, 190, 190)) { Opacity = 0.65 }; } }
                protected virtual Brush OtherMonthSelectedMouse { get { return new SolidColorBrush(Windows.UI.Color.FromArgb(255, 220, 220, 220)) { Opacity = 0.7 }; } }
            ...
            public CalendarGrid(DateTime month, DateTime? selectedDate)
            {
                ...
                Windows.UI.Color backgroundColor = Colors.Purple;
                ...
                SolidColorBrush brushOtherMonth = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 190, 190, 190));
                SolidColorBrush brushOtherMonthMouse = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 220, 220, 220));
            ...
            {
                Grid g = new Grid();
                g.Background = new SolidColorBrush(Windows.UI.Color.FromArgb(200, 230, 230, 230));
