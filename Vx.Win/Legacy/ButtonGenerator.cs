...
namespace InterfacesUWP
{
    ...
    public class ButtonDefault : ButtonAdvanced
    {
        public ButtonDefault()
        {
            ...
            BackgroundHover = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 114, 114, 114));
    ...
    public class ButtonSecondary : ButtonAdvanced
    {
        public ButtonSecondary()
        {
            ...
            BackgroundHover = new SolidColorBrush(Windows.UI.Color.FromArgb(255, 216, 216, 216));
