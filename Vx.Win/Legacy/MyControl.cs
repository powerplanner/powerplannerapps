...
namespace InterfacesUWP
{
    public class MyControl : Control
    {
        ...
        void MyGrid_PointerCaptureLost(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
        ...
        void MyGrid_PointerCanceled(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            ClearMouseDownAndMouseOver(e);
        }

        void MyGrid_PointerExited(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            ClearMouseDownAndMouseOver(e);
        }

        void MyGrid_PointerEntered(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            if (IsMouseOver)
                return;
        ...
        void MyGrid_PointerReleased(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            if (!IsMouseDown)
                return;
        ...
        void MyGrid_PointerPressed(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            if (IsMouseDown)
                return;
