...
{
    public class AddTaskOrEventViewController : PopupViewControllerWithScrolling<AddTaskOrEventViewModel>
    {
        public AddTaskOrEventViewController()
        {
        ...
        {
            Title = ViewModel.State == AddTaskOrEventViewModel.OperationState.Adding ?
                ViewModel.Type == TaskOrEventType.Task ? "Add Task" : "Add Event"
                : ViewModel.Type == TaskOrEventType.Task ? "Edit Task" : "Edit Event";
            ...
            }, nameof(ViewModel.Name), firstResponder: ViewModel.State == AddTaskOrEventViewModel.OperationState.Adding);
            ...
            if (ViewModel.Type == TaskOrEventType.Task)
            {
