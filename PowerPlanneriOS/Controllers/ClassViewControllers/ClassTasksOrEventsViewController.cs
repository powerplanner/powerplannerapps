...
namespace PowerPlanneriOS.Controllers.ClassViewControllers
{
    public class ClassTasksOrEventsViewController : BareMvvmUIViewController<ClassTasksOrEventsViewModel>
    {
        ...
        {
            private UITableView _tableView;
            private ClassTasksOrEventsViewModel _viewModel;
            ...
            public TableViewSource(UITableView tableView, ClassTasksOrEventsViewModel viewModel)
            {
            ...
            {
                if (_viewModel.Type == TaskOrEventType.Task)
                {
                    if (e.PropertyName == nameof(ClassViewItemsGroup.PastCompletedTasks))
                    {
                        ReloadData();
                    }
                }
                ...
                {
                    if (e.PropertyName == nameof(ClassViewItemsGroup.PastCompletedEvents))
                    {
                        ReloadData();
                    }
                }
        ...
        public void ScrollToItem(ViewItemTaskOrEvent changedItem)
        {
